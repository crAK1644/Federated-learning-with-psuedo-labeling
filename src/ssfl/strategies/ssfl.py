...
from flwr.common import ConfigRecord, Message, MessageType, MetricRecord, RecordDict
...
from ssfl.protocols.ssfl import ProposalResult, aggregate_votes
from ssfl.records import array_record_from_numpy, numpy_from_array_record


class SSFLStrategy(Strategy):
    def __init__(self, scenario: int, dataset_manifest_hash: str, num_open: int, num_clients: int) -> None:
        ...
        for msg in replies:
            ...
            proposals.append(
                (
                    ...
                    ProposalResult(
                        client_id=sender_id,
                        pseudo_labels=arrays["pseudo_labels"],
